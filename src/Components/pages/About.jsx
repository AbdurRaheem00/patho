  ...
  return (
    <section className="about-section" id="about"> 
      <div className="container">
        <h2 className="section-title">Where the Future of Learning Takes Flight</h2>
       <p className='para'> At Garuda, we believe immersive technology holds the key to shattering the limitations of traditional education.
        ...
        As you soar through lessons and challenges, Garuda celebrates your wins with exciting badges and rewards.
        These aren't just shiny trinkets – they're symbols of your conquered milestones and motivation to keep reaching for the clouds.
        Whether it's unlocking exclusive content, earning special recognition, or fueling a bit of friendly competition,
        Garuda's rewards system transforms your learning into a thrilling adventure, propelling you ever higher!
       </p> 
        <h2 className="section-title">Our Mission</h2>
        <p className="mission-statement">
        At Garuda, we believe the future of education is decentralized and infinitely explorable. 
        Our mission is to pioneer VR-powered learning environments that shatter the constraints of physical classrooms, unleashing the boundless potential of student curiosity. 
        Coupled with cryptocurrency-based tokenomics, we aim to incentivize not just passive consumption but active contribution, collaboration, and the organic growth of an educational metaverse.
        </p>
